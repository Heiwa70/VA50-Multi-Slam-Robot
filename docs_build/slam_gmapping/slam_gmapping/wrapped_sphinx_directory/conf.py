...
exec(open("/Users/clementseiler/Downloads/ros2_humble/docs_build/slam_gmapping/slam_gmapping/default_sphinx_project/conf.py").read())
...
ensure_global('project', "slam_gmapping")
ensure_global('author', """Brian Gerkey, Vincent Rabaud""")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['std_msgs', 'nav_msgs', 'tf2', 'tf2_ros', 'tf2_geometry_msgs', 'message_filters', 'rclcpp', 'sensor_msgs', 'visualization_msgs', 'openslam_gmapping']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "slam_gmapping Doxygen Project": "/Users/clementseiler/Downloads/ros2_humble/docs_build/slam_gmapping/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/Users/clementseiler/Downloads/ros2_humble/docs_build/slam_gmapping/slam_gmapping/wrapped_sphinx_directory/generated",
...
if rosdoc2_settings.get('automatically_extend_intersphinx_mapping', True):
    ...
    ensure_global('intersphinx_mapping', {
        'multirobot_map_merge': ('http://docs.ros.org/en/latest/p/multirobot_map_merge/', '/Users/clementseiler/Downloads/ros2_humble/cross_reference/multirobot_map_merge/objects.inv'),
        'multi_robot_exploration': ('http://docs.ros.org/en/latest/p/multi_robot_exploration/', '/Users/clementseiler/Downloads/ros2_humble/cross_reference/multi_robot_exploration/objects.inv'),
        'openslam_gmapping': ('http://docs.ros.org/en/latest/p/openslam_gmapping/', '/Users/clementseiler/Downloads/ros2_humble/cross_reference/openslam_gmapping/objects.inv')
    })
