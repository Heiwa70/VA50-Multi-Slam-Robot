...
exec(open("/Users/clementseiler/Downloads/ros2_humble/docs_build/multirobot_map_merge/multirobot_map_merge/default_sphinx_project/conf.py").read())
...
ensure_global('project', "multirobot_map_merge")
ensure_global('author', """Carlos Alvarez""")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['ament_cmake', 'geometry_msgs', 'nav_msgs', 'map_msgs', 'tf2_geometry_msgs', 'image_geometry']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "multirobot_map_merge Doxygen Project": "/Users/clementseiler/Downloads/ros2_humble/docs_build/multirobot_map_merge/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/Users/clementseiler/Downloads/ros2_humble/docs_build/multirobot_map_merge/multirobot_map_merge/wrapped_sphinx_directory/generated",
...
if rosdoc2_settings.get('automatically_extend_intersphinx_mapping', True):
    ...
    ensure_global('intersphinx_mapping', {
        'slam_gmapping': ('http://docs.ros.org/en/latest/p/slam_gmapping/', '/Users/clementseiler/Downloads/ros2_humble/cross_reference/slam_gmapping/objects.inv'),
