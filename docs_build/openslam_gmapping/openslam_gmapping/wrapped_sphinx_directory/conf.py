...
exec(open("/Users/clementseiler/Downloads/ros2_humble/docs_build/openslam_gmapping/openslam_gmapping/default_sphinx_project/conf.py").read())
...
ensure_global('project', "openslam_gmapping")
ensure_global('author', """Cyrill Stachniss, Giorgio Grisetti, Vincent Rabaud, Wolfram Burgard""")
ensure_global('release', "0.1.2")
ensure_global('version', "0.1")
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "openslam_gmapping Doxygen Project": "/Users/clementseiler/Downloads/ros2_humble/docs_build/openslam_gmapping/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/Users/clementseiler/Downloads/ros2_humble/docs_build/openslam_gmapping/openslam_gmapping/wrapped_sphinx_directory/generated",
