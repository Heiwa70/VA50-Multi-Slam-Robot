...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/Users/clementseiler/Downloads/ros2_humble/src/multi_robot_exploration/multi_robot_exploration', '..')))
...
copyright = 'The <multi_robot_exploration> Contributors. License: TODO: License declaration'
author = """cyril"""
